...
Reviewer code / 검수자 코드: **DE-R1-EDV65**   Language / 언어: **German (Deutsch)**   Items / 문항: **200**
...
## 1. Item judgments / 문항 판정 (`items-DE-R1-EDV65.csv`)
...
- `template-checklist-DE-R1-EDV65.csv`: record `checked` (yes/no), `issue` (yes/no) and comments per row.

## 3. Return / 제출

Return `items-DE-R1-EDV65.csv` and `template-checklist-DE-R1-EDV65.csv` to the operator. Keep a copy.
