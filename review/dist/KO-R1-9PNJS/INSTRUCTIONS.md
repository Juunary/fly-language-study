...
Reviewer code / 검수자 코드: **KO-R1-9PNJS**   Language / 언어: **Korean (한국어)**   Items / 문항: **200**
...
## 1. Item judgments / 문항 판정 (`items-KO-R1-9PNJS.csv`)
...
- `template-checklist-KO-R1-9PNJS.csv`: record `checked` (yes/no), `issue` (yes/no) and comments per row.

## 3. Return / 제출

Return `items-KO-R1-9PNJS.csv` and `template-checklist-KO-R1-9PNJS.csv` to the operator. Keep a copy.
