...
Reviewer code / 검수자 코드: **EN-R2-G4A2V**   Language / 언어: **English**   Items / 문항: **200**
...
## 1. Item judgments / 문항 판정 (`items-EN-R2-G4A2V.csv`)
...
- `template-checklist-EN-R2-G4A2V.csv`: record `checked` (yes/no), `issue` (yes/no) and comments per row.

## 3. Return / 제출

Return `items-EN-R2-G4A2V.csv` and `template-checklist-EN-R2-G4A2V.csv` to the operator. Keep a copy.
